...
public class TierConfig extends GSONConfig {
    ...
    public TierConfig(File directory) {
        ...
        tiers = new Tier[] {
                ...
                new Tier(27, true, true).addPaidReward("2x Junkie Key", "crate give to @p Junkie 2").addFreeReward("2x Uncommon Shards", "shard @p Uncommon 2").addFreeReward("1x Rare Shard", "shard @p Rare 1"),
                ...
                new Tier(31, false, true).addPaidReward("5x Divine Flawless Charms", "givedivine @p 5"),
                ...
                new Tier(43, false, true).addPaidReward("1x Junkie Key", "crate give to @p Junkie 1").addPaidReward("2x Rare Shards", "shard @p Rare 2"),
                new Tier(44, false, false),
                new Tier(45, true, true).addPaidReward("20x Regrade Artifacts", "giveartifact @p 20").addPaidReward("20x Flawless Charms", "giveflawless @p 20").addFreeReward("2x Rare Shards", "shard @p Rare 2").addFreeReward("1x Legendary Key", "crate give to @p Legendary 1"),
                ...
                new Tier(50, true, true).addPaidReward("Rainbow Track", "lp user @p set tracks.rainbow").addPaidReward("1x July Crate", "chest give @p july 1").addFreeReward("#Junkie2 Tag", "lp user @p set deluxetags.tag.junkie2").addFreeReward("50x Tokens", "te add @p 50").addFreeReward("1x Junkie Shard", "shard @p Junkie 1"),
        };
    }
